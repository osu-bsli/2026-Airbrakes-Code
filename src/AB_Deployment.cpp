...
{
    Variables.low = Variables.lastAngle - 1.0f;
    Variables.high = Variables.lastAngle + 1.0f;
    if (Variables.high > 95.0f) 
    {
        Variables.high = 95.0f;
    }

    if (Variables.low < 0.05f) 
    {
        Variables.low = 0.05f;
    }
    ...
    while ((Variables.high - Variables.low) > 0.1)
    {
    ...
    Variables.lastAngle = (Variables.low + Variables.high) / 2.0;
...
float PredictApogee(float* apogeeIC, AB_Predict_Apogee_Variables& Variables)
{
    ...
    while(Variables.velocityZ > 0.0 && Variables.iter < 1000) {
        ...
        Variables.drag1 = (0.5 / MASS) * Variables.k1_rho * drag_coeff(Variables.deploymentAngle, Variables.v_total1, Variables.positionZ) * surfaceA(Variables.deploymentAngle) * Variables.v_total1 * Variables.v_total1;
        ...
        Variables.drag2 = (0.5 / MASS) * Variables.k2_rho * drag_coeff(Variables.deploymentAngle, Variables.v_total2, Variables.posk1) * surfaceA(Variables.deploymentAngle) * Variables.v_total2 * Variables.v_total2;
        ...
        Variables.drag3 = (0.5 / MASS) * Variables.k3_rho * drag_coeff(Variables.deploymentAngle, Variables.v_total3, Variables.posk2) * surfaceA(Variables.deploymentAngle) * Variables.v_total3 * Variables.v_total3;
        ...
        Variables.drag4 = (0.5 / MASS) * Variables.k4_rho * drag_coeff(Variables.deploymentAngle, Variables.v_total4, Variables.posk3) * surfaceA(Variables.deploymentAngle) * Variables.v_total4 * Variables.v_total4;
